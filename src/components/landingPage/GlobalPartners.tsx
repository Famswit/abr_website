  ...
  return (
    <div className="py-10 px-4 md:px-20 bg-white">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 md:gap-8 max-w-6xl mx-auto">
        {[
          { src: "/images/partner1.png", alt: "The World Bank" },
          { src: "/images/partner17.png", alt: "Nieman Foundation" },
          { src: "/images/partner2.png", alt: "NEDBANK" },
          { src: "/images/partner3.png", alt: "Fledge" },
          { src: "/images/partner4.png", alt: "Pan-African Parliament" },
          { src: "/images/partner5.png", alt: "Business Day" },
          { src: "/images/partner6.png", alt: "Impact Hub Lagos" },
          { src: "/images/partner7.png", alt: "Africa Development Group" },
          { src: "/images/partner8.png", alt: "MIC" },
          {
